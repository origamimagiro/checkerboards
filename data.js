...
export const D = [
    ...
    [0, 5, "FC",  "miwu", 2020, 1, "5/16", "Book", "https://www.giladorigami.com/origami-database-book/4191/Multi-colorigami-by-Mi-Wu", ""],
    ...
    [1, 4,  "C",    "ku", 2020, 1, "4/8", "Flat-Folder, Instagram #084", "https://github.com/origamimagiro/flat-folder/tree/main/examples/instagram", ""],
...
for (let n = 5; n <= 20; ++n) {
    D.push([0, n, "C", "durei", 2015, 1, `${n}/${durei_side(n)}`, "Paper", DUREI, ""]);
}
